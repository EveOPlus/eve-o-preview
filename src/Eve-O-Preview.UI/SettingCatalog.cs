...
public static class SettingCatalog
{
    ...
    public static IReadOnlyList<SettingDefinition> All { get; } = new SettingDefinition[]
    {
        ...
        new("ShowCurrentSolarSystem", "Show system name", "All thumbnails", "Overlay", SettingKind.Toggle, Aliases: "solar system location"),
        new("SolarSystemColor", "Solar system text", "All thumbnails", "Overlay", SettingKind.Color, Aliases: "solar system location colour"),
        new("SolarSystemPlacement", "Placement", "Current solar system", "Overlay", SettingKind.Choice, Options: new[] { "Below", "Above", "Left", "Right" }, Aliases: "solar system location position title"),
        new("SolarSystemFontSize", "Font size (pixels)", "Current solar system", "Overlay", SettingKind.Number, 0, 200, Aliases: "solar system location size"),
        ...
        new("PreviewOverlayRenderer", "Preview graphics", "Enhanced graphics supports animated alerts. Compatibility graphics uses the existing title renderer. This choice applies to every profile.", "PreviewGraphics", SettingKind.Choice, Options: new[] { "NativeComposition", "Legacy" }, Aliases: "renderer overlay animation compatibility"),
        ...
        new("TitlePosition", "Title position", "Position on the thumbnail", "Overlay", SettingKind.Choice, Options: Enum.GetNames<EveOPreview.Preview.OverlayPosition>(), Aliases: "anchor location placement"),
        new("TitleFontOffsetLeft", "Title horizontal offset", "Adjust the title from its chosen position, in pixels. Negative values are allowed.", "Overlay", SettingKind.Number, -10000, 10000, Aliases: "position x left"),
